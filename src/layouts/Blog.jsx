...
import dashRoutes from 'routes/blog.jsx';
import { topbarStyle, menuStyle, menuType, topbarType, navWidth, chatWidth, chatType } from 'variables/settings/blog.jsx';
    ...
    render(){
        return (
            <div className="wrapper" ref="themeWrapper" data-menu={this.state.menuColor} data-topbar={this.state.topbarColor} data-menutype={this.state.menuType} data-topbartype={this.state.topbarType}>
                ...
                <Header {...this.props} navtype={navWidth} admintype={'blog'}/>
                

                <Sidebar {...this.props} routes={dashRoutes} admintype={'blog'}/>
                ...
                <ChatSidebar {...this.props} routes={dashRoutes} chatwidth={chatWidth}  chattype={chatType}/>
