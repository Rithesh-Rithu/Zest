                                        ...
                                        <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8">
                                            ...
                                            <form>
                                                <div className="form-row">
                                                    ...
                                                    <div className="form-group col-md-12">
                                                      <Label htmlFor="exampleSelect">Article Category</Label>
                                                    ...
                                                    <div className="form-group col-md-12">
                                                      <Label htmlFor="exampleSelect">Article Tags</Label>
                                                    ...
                                                    <div className="form-group col-md-12">
                                                      <Label htmlFor="exampleText">Article Excerpt</Label>
                                                    ...
                                                    <div className="form-group col-md-12">
                                                      ...
                                                      <div className="profileimg-input"><img alt="" src={IMGDIR+"/images/blog/blogs/blog-1.jpg"} className="img-fluid" style={{"width": "120px"}}/></div>
